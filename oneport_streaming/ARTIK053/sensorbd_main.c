...
#endif
{
	...
	case 2:
		...
		} else if (strcmp(argv[1], "audioagent") == 0) {
			audioagent_main(argc, argv);
		} else if (strcmp(argv[1], "oneport") == 0) {
			oneport_streaming_main(argc, argv);
		// } else if (strcmp(argv[1], "oneport_recoder") == 0) {
		//  	oneport_streaming_recoder_main(argc, argv);
		// } else if (strcmp(argv[1], "oneport_speaker") == 0) {
		// 	oneport_streaming_speaker_main(argc, argv);
		// } else if (strcmp(argv[1], "stm2") == 0) {
		// 	stm2_main(argc, argv);
		} else {
			show_usage(argv[0]);
		}
	...
	case 3:
		if (strcmp(argv[1], "mediaplayer") == 0) {
			mediaplayer_main(argc, argv);
		} else if (strcmp(argv[1], "recorder") == 0) {
			recorder_main(argc, argv);
		} else {
			show_usage(argv[0]);
		}
		break;
